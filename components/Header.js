          ...
          <div className=" flex justify-start flex-1 ">
            ...
            <div className=" navbar-collapse collapse grow " id="navbarSupportedContentY">
              <ul className="navbar-nav flex mr-auto">
                ...
                <li className="nav-item">
                  <a className={`nav-link block pr-3 lg:px-2 py-2 sm:font-xs font-lg text-gray-600 rounded-md hover:text-white hover:bg-blue-600 transition duration-150 ease-in-out ${route.pathname == '/recipes' ? 'bg-blue-600 text-white' : ''}`} href="/recipes" data-mdb-ripple="true" data-mdb-ripple-color="light">Recipes</a>
                </li>
                <li className="nav-item">
