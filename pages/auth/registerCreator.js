...
export default function registerCreator() {
  ...
  const handleRegister = async (e)=>{
    ...
    const registerRes = await fetch(`${process.env.STRAPI_API_URL}/api/auth/local/register`, {
      method: "POST",
      headers:{
    ...
    const uptRes = await fetch(`${process.env.STRAPI_API_URL}/api/users/${data.user.id}`, {  //upt the role of user after register
        method: "PUT",
        headers:{
          'Accept': 'application/json',
          'Content-Type': 'application/json',
